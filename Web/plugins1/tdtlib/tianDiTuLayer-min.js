        ...
        constructor: function (id, tdtType) {
            ...
            this.tileInfo = new esri.layers.TileInfo({
                ...
                "lods": [
					 ...
					 //{ "level": 19, "resolution": 0.00000536441802978515625, "scale": 1128.4994333441375 },
			   ]
            });
            this.loaded = true;
            this.onLoad(this);
...
//	//矢量注记  
//	dojo.declare("TDTVecAnnoLayer", TDTVecLayer, {  
//		getTileUrl: function(level, row, col) {  
//			return "http://t1.tianditu.cn/DataServer?T=cva_c&X=" + col + "&Y=" + row + "&L=" + level;  
//		}
//	});
//	//影像地图  
//	dojo.declare("TDTImageLayer", TDTVecLayer, {  
//		  getTileUrl: function(level, row, col) {//wmts  
//			  return "http://t1.tianditu.cn/DataServer?T=img_c&X=" + col + "&Y=" + row + "&L=" + level;  
//		  }
//	});
//	//影像注记 
//	dojo.declare("TDTImageAnnoLayer", TDTVecLayer, {  
//		  getTileUrl: function(level, row, col) {//wmts  
//			  return "http://t1.tianditu.cn/DataServer?T=cia_c&X=" + col + "&Y=" + row + "&L=" + level;  
//		  }
//	});
