...
oceans:{label:d.widgets.basemapToggle.basemapLabels.oceans,url:e+"/images/basemaps/oceans.jpg"},"national-geographic":{label:d.widgets.basemapToggle.basemapLabels["national-geographic"],url:e+"/images/basemaps/national-geographic.jpg"},osm:{label:d.widgets.basemapToggle.basemapLabels.osm,url:e+"/images/basemaps/osm.jpg"}}},
	constructor:function(a,b){
		...
		this._css={container:"basemapContainer",toggleButton:"toggleButton",basemapImage:"basemapImage",basemapTitle:"basemapTitle"}
	},
	postCreate:function(){
		this.inherited(arguments);
		this.own(k(this._toggleNode,s,f.hitch(this,this.toggle)))
	},
	startup:function(){
		...
		if(this.map.loaded)
			...
			k.once(this.map,"load",f.hitch(this,function(){this._init()}))
	},
	destroy:function(){this.inherited(arguments)},
	show:function(){this.set("visible",!0)},
	hide:function(){this.set("visible",!1)},
	toggle:function(){
		var a=this.map.getBasemap();
		a&&this.set("defaultBasemap",a);
		var a=this.get("defaultBasemap"),b=this.get("basemap"),c={previousBasemap:a,currentBasemap:b};
	...
	_init:function(){
		this._visible();
		this._basemapChange();
		k(this.map,"basemap-change",f.hitch(this,function(){this._basemapChange()}));
		this.set("loaded",!0);
		this.emit("load",{})
	},
	...
	_updateImage:function(){
		var a=this.get("basemap"),a=this._getBasemapInfo(a),b;
		...
		m.empty(this._toggleNode);
		m.place(b,this._toggleNode,"only")
	},
	_basemapChange:function(){
		var a=this.map.getBasemap();
		a&&this.set("defaultBasemap",a);
		var a=this.get("defaultBasemap"),b=this.get("basemap");
		this._updateImage();
		h.remove(this._toggleNode,a);
		h.add(this._toggleNode,b)
	},
	_updateThemeWatch:function(a,b,c){
		this.get("loaded")&&(h.remove(this.domNode,b),h.add(this.domNode,c)
	)},
	_visible:function(){
		this.get("visible")?l.set(this.domNode,"display",
	"block"):l.set(this.domNode,"display","none")}
	});

	p("extend-esri")&&f.setObject("dijit.BasemapToggle",g,q);
	return g
});