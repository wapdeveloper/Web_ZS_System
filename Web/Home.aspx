...
<head>
    ...
    <!-- <link rel="stylesheet" href="http://localhost:8094/3.9/js/dojo/dijit/themes/claro/claro.css" />
    <link rel="stylesheet" href="http://localhost:8094/3.9/js/esri/css/esri.css" /> -->

<%--    <link rel="stylesheet" type="text/css" href="http://192.168.0.129:8060/library/3.14/3.14/dijit/themes/claro/claro.css" />
    <link rel="stylesheet" type="text/css" href="http://192.168.0.129:8060/library/3.14/3.14/esri/css/esri.css" />--%>
    ...
    <%--<script type="text/javascript" src="http://192.168.0.129:8060/library/3.14/3.14/init.js"></script>--%>
    <script src="http://js.arcgis.com/3.14/"></script>

    <%--<script type="text/javascript" src="plugins1/TdtMapToggle/myApp/widget/TdtMapToggle.js"></script>--%>
    ...
    <script>
        ...
        require([
            "esri/map", "esri/layers/WebTiledLayer", "esri/layers/WMTSLayer", "esri/layers/WMTSLayerInfo",
            ...
            Map, WebTiledLayer, WMTSLayer, WMTSLayerInfo,
...
<body class="claro">
    ...
    <%--<div class="maincontainer" id="maincontainer">--%>
        ...
        <div id="wrapper" class="maincontainer" >
            ...
            <!-- Navigation -->
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0" id="navid">
                    ...
                    <div class="col-lg-12">
                        <ul class="nav navbar-top-links navbar-right">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-user">
                                    <li><a href="#"><i class="fa fa-user fa-fw"></i>测量</a></li>
                                    <li class="divider"></li>
                            ...
                            <div id="mapDiv">
                                ...
                                <div id="mapTypeDiv" class="mapType">
                                    ...
                                    <div class="basemapContainer">
                                        <div title="切换底图" role="button" class="toggleButton topo">
                                            <div class="basemapImage">
                                                <img alt="影像" src="dist/images/basemaps/imageType.png" onclick="addimage()">
                                            </div>
